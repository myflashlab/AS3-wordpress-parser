...
// ----------------------------------------------------------------------------------------------------------------------- funcs
		...
		private function initTitle():void
		{
			...
			_title.htmlText = "<font face='PT Sans Narrow' size='30' color='#3B5998'>"+ _data.title_plain +"</font>";
		...
		private function initDate():void
		{
			...
			_title2.embedFonts = false;
			_title2.mouseEnabled = false;
			_title2.htmlText = "<font face='PT Sans Narrow' size='15' color='#CCCCCC'>"+ _data.author.first_name + " " + _data.author.last_name + " - " + _data.date.toDateString() + "</font>";
