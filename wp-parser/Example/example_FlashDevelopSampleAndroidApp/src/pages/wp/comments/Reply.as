...
// ----------------------------------------------------------------------------------------------------------------------- funcs
		...
		private function initFields():void
		{
			...
			_nameTxt.border = false;
			//_nameTxt.borderColor = 0xE1E1E1;
			_nameTxt.background = true;
			_nameTxt.backgroundColor = 0xCED9E8;
			...
			_emailTxt.border = false;
			_emailTxt.background = true;
			_emailTxt.backgroundColor = 0xCED9E8;
			...
			_contentTxt.border = false;
			_contentTxt.background = true;
			_contentTxt.backgroundColor = 0xCED9E8;
			_contentTxt.data = {defaultValue:_contentStr};
			_contentTxt.defaultTextFormat = new TextFormat("Arimo", 20, 0x627AAD);
		...
		{
			this.dispatchEvent(new AppEvent(AppEvent.SUBMIT_COMMENT, {name:_nameTxt.text, email:_emailTxt.text, content:_contentTxt.text, post_id:_data.id}))
		}
