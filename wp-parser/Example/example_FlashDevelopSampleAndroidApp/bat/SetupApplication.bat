...
:: Android packaging
set AND_CERT_NAME="wp_parser"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\wpparser.p12
...
set IOS_PROVISION=cert\wpparser.mobileprovision
...
set APP_ID=air.wpparser

:: Output packages
set DIST_PATH=dist
set DIST_NAME=wpparser
